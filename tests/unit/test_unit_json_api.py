...
def test_json_api_gets_called__client_submits_valid_prompt__json_api_returns_valid_json_and_status_code_200(
    client, monkeypatch
):
...
def test_json_api_gets_called__client_submits_wrong_media_type__json_api_returns_400(
    client, monkeypatch
):
